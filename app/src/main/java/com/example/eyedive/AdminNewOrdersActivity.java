...
import com.example.eyedive.Model.AdminOrders;
...
public class AdminNewOrdersActivity extends AppCompatActivity {
    ...
    protected void onStart() {
        ...
        FirebaseRecyclerAdapter<AdminOrders , AdminOrdersViewHolder> adapter = new FirebaseRecyclerAdapter<AdminOrders, AdminOrdersViewHolder>(options) {
            ...
            protected void onBindViewHolder(@NonNull AdminOrdersViewHolder adminOrdersViewHolder, int i, @NonNull AdminOrders adminOrders) {
                ...
                adminOrdersViewHolder.userDateTime.setText("Date: "+ adminOrders.getDate() +" " + adminOrders.getTime() );
                adminOrdersViewHolder.userTotalPice.setText("Total Price "+ adminOrders.getTotal_amount());
    ...
    public static class AdminOrdersViewHolder extends RecyclerView.ViewHolder{
        ...
        public TextView userName, userPhoneNumber,userTotalPice,userDateTime,userShippingAddress;
        public AdminOrdersViewHolder(@NonNull View itemView) {
            super(itemView);

            userName = itemView.findViewById(R.id.order_user_name);
            userPhoneNumber = itemView.findViewById(R.id.order_phone_number);
            userTotalPice = itemView.findViewById(R.id.order_total_price);
