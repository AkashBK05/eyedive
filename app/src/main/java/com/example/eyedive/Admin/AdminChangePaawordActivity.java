...
public class AdminChangePaawordActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin_change_paaword);

        applyChangesbtn = findViewById(R.id.change_password_btn);
        oldPassword = findViewById(R.id.old_password);
        newPassword = findViewById(R.id.new_password);
        changepassword = findViewById(R.id.change_password);
        passwordRef = FirebaseDatabase.getInstance().getReference().child("Admin").child(Prevalent.currentOnlineUser.getPhone());
            ...
            passwordRef.updateChildren(passwordMap).addOnCompleteListener(new OnCompleteListener<Void>() {
                ...
                public void onComplete(@NonNull Task<Void> task) {
                    if (task.isSuccessful()) {
                        Toast.makeText(AdminChangePaawordActivity.this, "Changes applied successfully", Toast.LENGTH_SHORT).show();
                        Intent intent = new Intent(AdminChangePaawordActivity.this, AdminCategoryActivity.class);
